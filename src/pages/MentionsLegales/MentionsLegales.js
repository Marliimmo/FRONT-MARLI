    ...
    <div className={`fadinAnimation ${styles.allContainer}`}>
      ...
      <div>
        ...
        <p>
          ...
          pris connaissance des présentes conditions d’utilisation et s’engage à
          les respecter. <br />
          <br />
          L’utilisateur du site internet marli-immobilier.com reconnaît disposer
          de la compétence et des moyens nécessaires pour accéder et utiliser ce
          site. <br />
          <br />
          ...
          mais ne saurait être tenue pour responsable des erreurs, d’une absence
          de disponibilité des fonctionnalités et/ou de la présence de virus sur
          son site. <br />
          <br />
          ...
          <br />
          Marli-immobilier.com ne saurait garantir l’exactitude, la complétude,
          l’actualité des informations diffusées sur son site. En conséquence,
          l’utilisateur reconnaît utiliser ces informations sous sa
          responsabilité exclusive. <br />
          <br />
        </p>
        ...
        <p>
          ...
          sont la propriété exclusive du site marli-immobilier.com.
          <br />
          <br />
          Toute représentation totale ou partielle de ce site ou de son contenu
          par quelle que personne que ce soit, sans l’autorisation expresse et
          écrite du site marli-immobilier.com est interdite et constituerait une
          contrefaçon sanctionnée par les articles L. 335-2 et suivants du Code
          de la propriété intellectuelle qui définit la contrefaçon comme un
          délit, et prévoit jusqu’à trois ans d’emprisonnement et 300 000 euros
          d’amende.
          <br />
          <br />
          Il en est de même des bases de données figurant, le cas échéant sur le
          site web qui sont protégées par les dispositions de la loi du 1er
          ...
          <br />
          <br />
          Les marques du site marli-immobilier.com et de ses partenaires, ainsi
          que les logos figurant sur le site sont des marques déposées. Toute
          reproduction totale ou partielle de ces marques ou de ces logos
          effectués à partir des éléments du site sans l’autorisation expresse
          du site cine-loges.fr est donc prohibée au sens du Code de la
          ...
          cadre du site internet en direction d’autres ressources présentes sur
          le réseau.
          <br />
          <br />
